...
from .sampler import EnsembleSampler, OAC, StepSampler, TrajSampler, CQLUnexploredSampler
...
def main(argv):
    ...
    train_sampler = CQLUnexploredSampler(gym.make(FLAGS.env).unwrapped, FLAGS.max_traj_length, qf1, qf2, FLAGS.device)
